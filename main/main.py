...
if __name__ == "__main__":
    ...
    local_keystone = clients.create_keystone_client(credentials)
    local_glance = clients.create_glance_client(local_keystone)
    local_swift = clients.create_swift_client(credentials)
    local_nova = clients.create_nova_client(credentials)
